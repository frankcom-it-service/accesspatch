...
- Phase 1B can collect schema-valid evidence and obtain a deterministically constrained repair plan only for the two seeded findings. Arbitrary-repository inspection, patch generation or application, replay generation, proof export, rollback, and the complete product workflow are **NOT YET IMPLEMENTED**.
