...
| Final submission video | COMPLETE; PUBLIC; OWNER-VERIFIED LOGGED OUT | `https://www.youtube.com/watch?v=eCHig9YUwU0`; duration `2:49`; custom thumbnail; corrected timed English captions; `VIDEO_SCRIPT.md`; `VIDEO_PRIVACY_CHECKLIST.md` |
...
| Public YouTube demo, at most three minutes | Mandatory | COMPLETE; PUBLIC; OWNER-VERIFIED LOGGED OUT | `https://www.youtube.com/watch?v=eCHig9YUwU0`; final duration `2:49`; `VIDEO_SCRIPT.md`; corrected timed English captions | Demo and submission | 2026-07-21 02:00 CEST | Devpost video-link entry remains pending; no independent automated YouTube fetch is claimed |
| Voiceover explains project, Codex use, and GPT-5.6 use | Mandatory | FINAL VIDEO PRODUCED AND OWNER-REVIEWED | `VIDEO_SCRIPT.md`; public video URL above; no live GPT-5.6 call; tracked evidence only | Demo and submission | 2026-07-21 02:00 CEST | Devpost entry and final submission remain pending |
...
| Primary build-thread `/feedback` identifier | Mandatory | COMPLETE; RETURNED THREAD ID RECORDED | `CODEX_SESSION_RECORD.md`; Thread ID `019f65ad-d02e-7ce3-9029-bb6a480c3275` | Submission | 2026-07-21 02:00 CEST | Devpost form entry and final external verification remain pending |
...
| Fresh install and final link verification | Recommended | FRESH INSTALL VERIFIED ON DEBIAN; VIDEO LINK OWNER-VERIFIED; OTHER FINAL LINKS OPEN | `TEST_EVIDENCE.md`; `docs/hackathon/evidence/phase3b-clean-clone/`; public video URL; checklist | Verification release gate | 2026-07-21 02:00 CEST | Repository invitation acceptance, independent judge clone, Devpost links, and remaining final link checks remain open |
